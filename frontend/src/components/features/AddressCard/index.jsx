        ...
        <div id="adr-item">
            <div className="adr-item-detail">
                <div className="adr-grp">
                    <span className="adr-comp">{street}</span><br/>
                ...
                <div className="ftn">
                    ...
                    <Popup
                        trigger={
                                <button onClick={handleClose} style={{marginLeft: "50px"}}><ModeEditIcon fontSize="medium"/></button>
                        }
                    ...
                    >
                        {(close) => (
                            <div className="popup-address">
                                ...
                                <select className="location" id="district"
                                    onChange={(event) => {
                                ...
                                <select className="location" id="ward"
                                    onChange={(event) => {
                                ...
                                <input className="location" type="text" placeholder="Số nhà" value={soNha}
                                    onChange={(event) => {
                    ...
                    <span className="delete-adr"><button onClick={() => handleDelete()} style={{ marginLeft: "10px" }}><DeleteIcon fontSize="medium" /></button></span>
                </div>
            </div>
        </div>
    )
